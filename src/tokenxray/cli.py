...
def main():
    ...
    parser.add_argument(
        "--top", "-t", type=int, help="Show top N sessions (default: 15)"
    )
    parser.add_argument(
        "--projects", "-p", action="store_true", help="Cost breakdown by project"
    )
    parser.add_argument(
        "--diagnose", "-d", action="store_true", help="Money-saving recommendations"
    )
    parser.add_argument(
        "--baseline", "-b", action="store_true", help="Save current stats as baseline"
    )
    parser.add_argument(
        "--compare", "-c", action="store_true", help="Compare against saved baseline"
    )
    ...
    parser.add_argument(
        "--confirm", action="store_true", help="Auto-confirm hook installation"
    )
    parser.add_argument(
        "--doctor",
        action="store_true",
